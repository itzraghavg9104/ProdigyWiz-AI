...
genai.configure(api_key="AIzaSyCY2Zi92P1VQI3DeF2ypXI2jOsb9_tXvuY")
...
model = genai.GenerativeModel(
    ...
    system_instruction='''Your Role: ProdigyWiz AI - A highly efficient, expert ProdigyWiz designed to provide structured and comprehensive learning experiences.
